...
//        System.out.println("jsonObject==>" + jsonObject);
        ...
        System.out.println(carListEntity.getLicensePlateAreaName() + carListEntity.getCarNumber());
        if (isMatch) {
    ...
    public String carEdit (Model model, HttpServletRequest request,@PathVariable("carId") int carId) {
        List<CarLicenseListEntity> licenseListEntities = carLicenseListService.selectAllLicense();
